  ...
  pages: [
    {
      ...
      sections: {
        hero: {
          ...
          ctaHref: "#contact",
          image: {
            alt: "Editorial illustration of a team reviewing weekly plans",
            promptHint: "Editorial product illustration with a clear, modern workflow scene",
          },
        },
        about: {
          variant: "stacked",
          ...
          tiers: [
            {
              ...
              price: "$199",
              billingPeriod: "/mo",
              description: "Clear starter scope for smaller teams.",

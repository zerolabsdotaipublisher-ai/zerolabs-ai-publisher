  ...
  return (
    <div className="flex flex-col lg:grid lg:grid-cols-[250px_1fr_300px] gap-6">
      ...
      <aside className="app-card flex flex-col gap-4 h-fit sticky top-6">
        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Community</h2>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div className="overflow-hidden">
            <div className="font-medium text-[var(--text-primary)] truncate">{getProfileDisplayName(profile)}</div>
            <div className="text-xs text-[var(--text-muted)] truncate">{user.email}</div>
          </div>
        </div>
        <div className="text-sm text-[var(--text-secondary)] border-t border-gray-100 dark:border-gray-800 pt-4">
      ...
      <aside className="app-card flex flex-col gap-4 h-fit sticky top-6">
        <h2 className="text-lg font-semibold text-[var(--text-primary)] mb-2">Public Websites</h2>
        <div className="text-xs text-[var(--text-muted)] mb-2">Discover what others are building</div>
